...
const kafka = new Kafka({
    ...
    brokers: config.KAFKA_BROKERS.split(','), // e.g., 'kafka-1:29092,kafka-2:29093,kafka-3:29094'
});
        ...
        eachMessage: async ({ topic, partition, message }) => {
            try {
                ...
                if (eventType === 'user-created') {
                    ...
                    await setCache(`profile:${userData.userId}`, JSON.stringify(newProfile.toObject()), config.REDIS_CACHE_TTL);
